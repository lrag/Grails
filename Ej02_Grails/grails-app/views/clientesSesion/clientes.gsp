...
<div class=" container-fluid">
    ...
    <div class="text-center jumbotron">
        <h2>Gestión de clientes (sesión)</h2>
    </div>

    <g:form controller="clientesSesion" method="POST">
    ...
    <div class="row">
        <table class="table table-stripped table-hover col-8 offset-2 mt-3">
            ...
            <g:each in="${listadoClientes}" var="c">
                <tr>
                    <td>
                        <g:link controller="clientesSesion" action="seleccionarCliente" params="[id:c.id]">${c.nombre}</g:link>
                    </td>
                    <td>${c.direccion}</td>
                    <td>${c.telefono}</td>
                </tr>
